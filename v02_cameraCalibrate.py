...
PHOTO_PATH = "C:\\Users\\15518\\Desktop\\camera_home"
PHOTO_TYPE = '\\*.jpg'
...
def calibration_photo(photo_path):
    ...
    world_point[:, :2] = SQUIRE_SIZE * np.mgrid[:x_nums, :y_nums].T.reshape(-1, 2)
    ...
    # 获取所有标定图
    images = glob.glob(photo_path + PHOTO_TYPE)
    # print(images)
